bm.file.good = read.table(
  file = "./../benchmark/mem_benchmark/memory_track/bm_mem_iters13.txt",
  header = TRUE,
  sep = ";"
)
...
bm.file.bad = read.table(
  file = "./../benchmark/mem_benchmark/memory_track/bm_mem_iters14.txt",
  header = TRUE,
  sep = ";"
)
...
bm.file.good = read.table(
  file = "./../benchmark/mem_benchmark/memory_track/bm_mem_iters15.txt",
  header = TRUE,
  sep = ";"
)
bm.file.good$used.memory.centered = bm.file.good$used.memory - bm.file.good$used.memory[1]
...
bm.file.bad = read.table(
  file = "./../benchmark/mem_benchmark/memory_track/bm_mem_iters16.txt",
  header = TRUE,
  sep = ";"
)
bm.file.bad$used.memory.centered = bm.file.bad$used.memory - bm.file.bad$used.memory[1]
